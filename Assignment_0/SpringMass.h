...
protected:
  ...
  double pos_eqm,vel_eqm;
  int t;
  /**
   * @brief move the spring and save the current position and velocity in the vectors positions and velocities
   */
  virtual void move_spring();
